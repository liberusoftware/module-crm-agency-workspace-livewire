...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-crm-agency-workspace-livewire?sort=semver)](https://github.com/liberusoftware/module-crm-agency-workspace-livewire/releases/latest) [![Tests](https://github.com/liberusoftware/module-crm-agency-workspace-livewire/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-crm-agency-workspace-livewire/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-crm-agency-workspace-livewire
```
...
<a href="https://github.com/liberusoftware/module-crm-agency-workspace-livewire/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-crm-agency-workspace-livewire" alt="Contributors to liberusoftware/module-crm-agency-workspace-livewire">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-crm-agency-workspace-livewire/graphs/contributors).
